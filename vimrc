...
if has("autocmd")
    ...
    autocmd FileType arduino,c,cpp,java,php,python,javascript,coffee,eco,html,css,mako,sql,json,rst,cucumber,yaml autocmd BufWritePre <buffer> :call StripTrailingWhitespaces()
    autocmd FileType arduino,c,cpp,java,php,python,javascript,coffee,eco,html,css,mako,sql,json,rst,cucumber,yaml autocmd BufWritePre <buffer> :call TrimEndLines()
