...
if has("autocmd")
    ...
    autocmd FileType c,cpp,java,php,python,javascript,coffee,eco,html,css,mako,sql,json,rst autocmd BufWritePre <buffer> :call StripTrailingWhitespaces()
    autocmd FileType c,cpp,java,php,python,javascript,coffee,eco,html,css,mako,sql,json,rst autocmd BufWritePre <buffer> :call TrimEndLines()
